...
@Component
class JwtRequstFilter
    (private val jwtUtil:JwtUtil,
            private val memberDetailsService: MemberDetailsService):OncePerRequestFilter()
{
    override fun doFilterInternal(
        ...
        if(!username.isNullOrEmpty()
            && jwtUtil.validateToken(accessToken!!,username)&&SecurityContextHolder.getContext().authentication==null){
